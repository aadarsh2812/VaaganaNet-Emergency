...
const NAV = [
  { to: '/control',    label: 'Control Centre',  sub: 'Fleet & Dispatch',       icon: IconControl },
  { to: '/ambulance',  label: 'Ambulance',        sub: 'Driver & Paramedic',     icon: IconAmb },
  { to: '/hospital',   label: 'Hospital',         sub: 'Receiving & Triage',     icon: IconHosp },
  { to: '/simulation', label: 'Simulation',       sub: 'Demo & Testing',         icon: IconSim },
]
      ...
      <aside style={{
        ...
        <div style={{ width: 250, display: 'flex', flexDirection: 'column', height: '100%' }}>
          ...
          <nav style={{ padding: '12px 10px', flex: 1, overflowY: 'auto' }}>
            ...
            {NAV.map(n => (
              <NavLink key={n.to} to={n.to} style={{ textDecoration: 'none', display: 'block', marginBottom: 2 }}>
                {({ isActive }) => (
